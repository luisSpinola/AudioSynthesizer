...
Oscillator6::Oscillator6(SynthAudioProcessor& p) : processor(p) {
    ...
    waveSelection = new AudioProcessorValueTreeState::ComboBoxAttachment(processor.tree, "wavetype6", oscMenu);
    ...
    frequencySelection = new AudioProcessorValueTreeState::ComboBoxAttachment(processor.tree, "frequency6", oscFrequency);
    ...
    blendVal = new AudioProcessorValueTreeState::SliderAttachment(processor.tree, "blend6", blendSlider);
}
