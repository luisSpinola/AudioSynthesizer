...
Oscillator5::Oscillator5(SynthAudioProcessor& p) : processor(p) {
    setSize(200, 140);
    ...
    waveSelection = new AudioProcessorValueTreeState::ComboBoxAttachment(processor.tree, "wavetype5", oscMenu);
    ...
    frequencySelection = new AudioProcessorValueTreeState::ComboBoxAttachment(processor.tree, "frequency5", oscFrequency);
    ...
    blendVal = new AudioProcessorValueTreeState::SliderAttachment(processor.tree, "blend5", blendSlider);
}

Oscillator5::~Oscillator5() {}

void Oscillator5::paint(Graphics& g) {
    //Background
    ...
    g.drawText("Oscillator 5", titleArea, Justification::centredTop);
